  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => Dismissible(
        key: UniqueKey(),
        background: Container(color: Colors.red[400], child: Center(child: Text('NoOOOooo donde te sentaaAAaasteeEEee', style: TextStyle( color: Colors.white, fontWeight: FontWeight.w800),), ),),
